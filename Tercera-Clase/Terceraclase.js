...
var password =prompt("Ingrese una contraseña de 8 caracteres minimo y sin espacios")

const validacion = (password) => {
    if(password.length<8 || password.includes(" ") == true){
        console.log("Su contraseña no cumple con 8 caracteres minimos o contiene espacios")
...
let number = prompt("Ingrese un numero del 1 al 7 y le devolvera el dia de la semana correspondiente")
...
let edad  = prompt("Ingrese su edad para saber si usted es mayor o menor de edad")
...
const date = (day,month,year) =>{
    if (day<=31 && month<=12 && year<=2023){
        return console.log ("La fecha ingresada es: " + day + "/" + month + "/" + year)
